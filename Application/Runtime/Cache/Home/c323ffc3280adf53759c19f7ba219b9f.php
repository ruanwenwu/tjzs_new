...
<div class="page">
	<div class="container" _v-b83450c2="">
		<div class="weui_search_bar" style="width:100%;position:fixed;top:0" _v-b83450c2="">
			<form action="" method="get" class="weui_search_outer" _v-b83450c2="">
		...
		<div id="" class="" _v-b83450c2="" style="">
			<div class="scroller" _v-b83450c2="" style="transition-property: transform; transform-origin: 0px 0px 0px; transform: translate(0px, 40px) scale(1) translateZ(0px);">
				<div class="weui_cells weui_cells_access" style="margin-top: -1px;" _v-b83450c2="">
					<!--v-for-start-->
					<?php if(is_array($departments)): foreach($departments as $key=>$vo): ?><a class="weui_cell" href="/index.php/Home/Index/departBriefDetail/id/<?php echo ($vo['deptid']); ?>" _v-b83450c2="">
