		...
		<div id="reg-detail" class="reg-detail weui-cells_form" _v-0be13b8c="">
			...
			<div class="weui_cells" _v-0be13b8c="">
				...
				<div class="weui_cell" _v-0be13b8c="">
					<div class="weui_cell_bd weui_cell_primary" _v-0be13b8c="">
						<p _v-0be13b8c="">
							<span class="label" _v-0be13b8c="">手&nbsp;&nbsp;机&nbsp;&nbsp;号</span><span class="info" id="phonenum" _v-0be13b8c=""><?php echo ($userInfo['phoneno']); ?></span>
						</p>
					</div>
				</div>
				<div class="weui-cell weui-cell_vcode">
                        ...
                        <div class="weui-cell__ft">
                            <img id="verifyimg" style="padding:3px;" class="weui-vcode-img" src="<?php echo ($vcode); ?>">
                        </div>
            		</div>
				<div class="weui-cell weui-cell_vcode">
