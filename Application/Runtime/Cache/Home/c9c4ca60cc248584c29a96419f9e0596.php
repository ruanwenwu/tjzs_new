...
<link href="/app/css/zs.css" rel="stylesheet">
</head>
<body>
...
<div class="page">
	<div class="container" _v-b83450c2="">
		<div class="weui_search_bar" style="width:100%;position:fixed;top:0" _v-b83450c2="">
			<form action="/index.php/Home/Index/departlist" method="get" class="weui_search_outer" _v-b83450c2="">
				<div class="weui_search_inner" _v-b83450c2="">
					<i class="weui_icon_search" _v-b83450c2=""></i>
					<input name="depname" class="weui_search_input" id="depart_list_search_input" placeholder="搜索科室" _v-b83450c2="" type="search">
				</div>
			</form>   
		</div>
		<div id="" class="" _v-b83450c2="" style="">
			<div class="scroller" _v-b83450c2="" style="transition-property: transform; transform-origin: 0px 0px 0px; transform: translate(0px, 40px) scale(1) translateZ(0px);">
				<div class="weui_cells weui_cells_access" style="margin-top: -1px;" _v-b83450c2="">
					<!--v-for-start-->
					<?php if(is_array($departments)): foreach($departments as $key=>$vo): ?><a class="weui_cell" href="/index.php/Home/Index/departmentArrange/deptid/<?php echo ($vo['deptid']); ?>" _v-b83450c2="">
						<div class="weui_cell_hd" _v-b83450c2="">
							<i class="fa fa-group icon-color" style="width:20px;margin-right:5px;display:block" _v-b83450c2=""></i>
						</div>
						<div class="weui_cell_bd weui_cell_primary" _v-b83450c2="">
							<p _v-b83450c2="">
								<?php echo ($vo['deptname']); ?> 
							</p>  
						</div>
						<div class="weui_cell_ft" _v-b83450c2="">
						</div>
					</a><?php endforeach; endif; ?>
					<!--v-for-end-->
				</div>
				<div _v-b83450c2="" style="display: none;">
					<div class="weui_cells_title" _v-b83450c2="">
					</div>
					<div class="weui_cells weui_cells_access" _v-b83450c2="">
