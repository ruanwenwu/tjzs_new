...
<div class="page">
	<div class="container" _v-3a85f76e="">
		<div class="weui_panel weui_panel_access" _v-3a85f76e="">
			<div class="weui_panel_bd" _v-3a85f76e="">
				<div class="weui_media_box weui_media_appmsg" _v-3a85f76e="">
					<div class="weui_media_hd" _v-3a85f76e="">
						<i class="fa fa-user-md fa-2x icon-color" _v-3a85f76e=""></i>
					</div>
					<div class="weui_media_bd" _v-3a85f76e="">
						<h4 class="weui_media_title" _v-3a85f76e=""><?php echo ($docInfo['doctorname']); ?> <span class="am-ft-gray am-ft-13" _v-3a85f76e=""><?php echo ($visitTypeInfo['visitname']); ?></span></h4>
						<p class="weui_media_desc" _v-3a85f76e="">
							<?php echo ($deptInfo['deptname']); ?>
						</p>
						<p _v-3a85f76e="">
							<span class="orange_tag" style="margin-right:10px;" _v-3a85f76e=""><?php echo ($docInfo['doctorlevel']); ?>头衔</span><span class="orange_tag" _v-3a85f76e=""><?php echo ($visitTypeInfo['cost']); ?>元</span>
						</p> 
					</div>
				</div>
			</div>
		...
		<div id="" class="" _v-3a85f76e="" style="">
			<div class="scroller" _v-3a85f76e="" style="transition-property: transform; transform-origin: 0px 0px 0px; transform: translate(0px, 0px) scale(1) translateZ(0px);">
				<div class="weui_cells_title" _v-3a85f76e="">
					<?php if($timeSpan): ?>请选择就诊时段<?php else: ?>暂无时段信息<?php endif; ?>
				</div>   
				<div class="weui_cells weui_cells_access" _v-3a85f76e="">
					<!--v-for-start-->    
					<?php if(is_array($timeSpan)): foreach($timeSpan as $key=>$vo): ?><a class="weui_cell" href="<?php if($vo['RemainingNum'] > 0): ?>/index.php/Home/Index/preorder/realid/<?php echo ($realid); ?>/peroid/<?php echo ($vo['PeriodID']); ?>/periodname/<?php echo ($vo['PeriodName']); else: ?>javascript:;<?php endif; ?>" _v-3a85f76e="">
					<div class="weui_cell_hd" _v-3a85f76e="">
						<i class="fa fa-clock-o icon-color" style="width:20px;margin-right:5px;display:block" _v-3a85f76e=""></i>
					</div>
					<div class="weui_cell_bd weui_cell_primary" _v-3a85f76e="">  
						<p _v-3a85f76e="">
							<?php echo ($vo['PeriodName']); ?> <span style="margin-left:8px" class="blue_tag" _v-3a85f76e=""><?php if($vo['RemainingNum'] > 0): echo ($vo['RemainingNum']); ?>号<?php else: ?>已满<?php endif; ?></span>
						</p>
					</div>
